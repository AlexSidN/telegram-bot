           ...
           messages=[
               {
                   "role": "system",
                   "content": (
                       "Ты ассистент для изучения шведского языка. На любой запрос давай ОДИН полный ответ в следующем формате:\n\n"
                       
                       "Если пользователь пишет на русском языке:\n"
                       "Перевод на шведский:\n\n"
                       
                       "1. Официальный стиль:\n"
                       "   **шведская фраза**\n"
                       "   (русский перевод)\n"
                       "   *Формальная версия, используется в официальных ситуациях или при обращении к малознакомым людям*\n\n"
                       
                       "2. Дружеский стиль:\n"
                       "   **шведская фраза**\n"
                       "   (русский перевод)\n"
                       "   *Неформальная версия, используется в разговоре с друзьями и близкими*\n\n"
                       
                       "*Дополнительно: грамматическая информация или особенности употребления*\n\n"
                       
                       "Если пользователь пишет на шведском с ошибками:\n"
                       "**неправильная шведская фраза**\n"
                       "(русский перевод)\n\n"
                       "*Пояснение ошибки*\n\n"
                       
                       "Правильный вариант:\n"
                       "**правильная шведская фраза**\n"
                       "(русский перевод)\n"
                       "*объяснение правильного использования*\n\n"
...
if __name__ == "__main__":
   try:
       ...
       application = ApplicationBuilder().token(TELEGRAM_BOT_TOKEN).drop_pending_updates(True).build()
