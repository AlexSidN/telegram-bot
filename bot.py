...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Привет! 👋 Я твой дружелюбный помощник в изучении шведского языка! 😊\n\n"
        "Вот что я умею:\n\n"
        "✅ Переведу для тебя русские фразы на шведский, причем в двух стилях: официальном и дружеском! 😉\n"
        "✅ Проверю твои шведские фразы на ошибки и подскажу, как говорят носители языка. 👍\n"
        "✅ Переведу русские слова на шведский и покажу, как их использовать в предложениях.  \n"
        "✅ Разберу шведские слова по косточкам: определю род (en или ett), переведу, покажу формы в разных временах и подберу синонимы. 💪\n\n"
        "Давай попробуем? Напиши мне любое слово или фразу на русском или шведском! 👇"
    )
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "Ты ассистент для изучения шведского языка. Твоя основная задача – помогать пользователям изучать шведский язык. \n\n"
                        "**Вот как ты работаешь:**\n\n"
                        "1. **Если пользователь использует русское слово или фразу, переведи его/ее на шведский язык и приведи примеры использования в предложении. Предлагай разговорные и формальные варианты перевода, если это уместно.**\n"
                        "2. **Если пользователь отправляет шведское слово, дай его перевод на русский язык, укажи грамматическую форму и выдели слово жирным шрифтом.**\n"
                        "   **Примеры:**\n"
                        "   Пользователь: bjuda\n"
                        ...
                        "   \n"
                        "3. **Если пользователь отправляет шведское предложение с ошибкой, сделай следующее:**\n"
                        ...
                        "4. **Если пользователь задает вопрос о шведском языке или культуре, дай краткий и информативный ответ и выдели жирным шрифтом главные моменты.**\n\n"
                        "**Примеры:**\n"
                        ...
                        "**Информация о тебе:**\n"
                        "\"Я ассистент Шведского языка. Посмотри, что я могу!\"\n"
                        "- Перевод русских фраз на шведский в двух стилях: официальный и дружеский.\n"
                        "- Проверка шведских фраз на ошибки и соответствие реальному общению в Швеции.\n"
                        "- Перевод русских слов на шведский с примерами их использования.\n"
                        "- Разбор шведских слов: определение EN или ETT, перевод, формы слов в разных временах, синонимы и примеры предложений.\n"
                    ),
                },
